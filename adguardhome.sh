...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://ghproxy.com/https://raw.githubusercontent.com/YY-China/Adguardhome-Config/main/AdGuardHome
